...
static void _DumpMaterials(Q3BSP* bsp, COLLADASW::StreamWriter* sw)
{
    MaterialExporter materialExporter(sw, bsp);
    materialExporter.add();

    EffectExporter effectExporter(sw, bsp);
    effectExporter.add();

    ImageExporter imageExporter(sw, bsp);
    imageExporter.add();
}
